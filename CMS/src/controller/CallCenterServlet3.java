...
/**
 * Servlet implementation class CallCenterServlet3
 */
public class CallCenterServlet3 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CallCenterServlet3() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(rs.next())
		{
			...
			session.setAttribute("con", rs.getString(5));
			session.setAttribute("addr", rs.getString(6));*/
